      ...
      <Dialog open={open} onClose={setOpen} className="relative z-10">
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <DialogPanel
              transition
              className="relative transform overflow-hidden rounded-lg border border-white/40 bg-white/20 px-4 pt-5 pb-4 text-left shadow-xl outline -outline-offset-1 outline-white/10 backdrop-blur-sm transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in sm:my-8 sm:w-full sm:max-w-lg sm:p-6 data-closed:sm:translate-y-0 data-closed:sm:scale-95"
            >
              <div className="sm:flex sm:items-start">
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  >
                    Welcome to my 30th Bday Celebration!
                  </DialogTitle>
                  <div className="mt-2">
                    <p className="text-md text-white">
                      If you got this far, it means you are one of the lucky few
                      that got the secret link to this website. I hope you enjoy
                      the celebration and have a great time.
                    </p>
                  </div>
                </div>
              </div>
